...
#ifndef __ZMQ_SSPI_SERVER_HPP_INCLUDED__
#define __ZMQ_SSPI_SERVER_HPP_INCLUDED__
...
class sspi_server_t : public sspi_mechanism_base_t, public zap_client_t
{
  public:
    sspi_server_t (session_base_t *session_,
                     const std::string &peer_address,
                     const options_t &options_);
    virtual ~sspi_server_t ();
