...
#ifndef __ZMQ_SSPI_CLIENT_HPP_INCLUDED__
#define __ZMQ_SSPI_CLIENT_HPP_INCLUDED__
...
class sspi_client_t : public sspi_mechanism_base_t
{
  public:
    sspi_client_t (session_base_t *session_, const options_t &options_);
    virtual ~sspi_client_t ();
